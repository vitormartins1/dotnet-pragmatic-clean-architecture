...
public sealed class AdminAuthorizationDelegatingHandler : DelegatingHandler
{
    ...
    {
        var authrorizationRequestParameters = new KeyValuePair<string, string>[]
        {
        ...
        var authorizationRequestContent = new FormUrlEncodedContent(authrorizationRequestParameters);
